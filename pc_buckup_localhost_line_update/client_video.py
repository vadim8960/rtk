...
def video_thread():
	...
	while 1:
		...
		ret, binary = cv2.threshold(blur, 100, 255, cv2.THRESH_BINARY_INV)
		...
		for it in range(140, 200):
			if (binary[410, it] == 0):
				left += 1

		for it in range(440, 500):
			if (binary[410, it] == 0):
				right += 1

		error = (left - right)

		cv2.line(image, (140, 410), (240, 410), (255, 0, 0), 3)
		cv2.line(image, (400, 410), (500, 410), (255, 0, 0), 3)
